...
<div class="row card p-5 text-center">
    <div class="row margin-tb">
        ...
        <div class="col-sm-1">
            <a class="btn btn-primary" href="{{ route('data.index') }}"><i class="fa-solid fa-house"></i></a>
        </div>
    </div>
</div>
</div>
...
<div class="container card shadow-lg p-3 mb-5" style="width: 50rem;">
        <div class="row mb-12 p-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="time" id="time" placeholder="Enter Time">
          </div>
        </div>
